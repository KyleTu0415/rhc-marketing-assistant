"""RHC Medical - Social Media Copy Generator (v2)

Formatting rules:
1. Each post has 1-3 key points max
2. Content split into paragraphs, each starts with symbol/bullet
3. Titles are human-sounding, can use rhetorical questions
4. Each platform has its own style
"""
