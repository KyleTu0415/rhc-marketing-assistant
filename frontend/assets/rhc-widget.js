...
(function () {
  ...
  var WIDGET_CSS =
    ...
    '#rhc-widget-panel{position:fixed;right:20px;bottom:88px;width:92%;max-width:420px;min-height:400px;max-height:75vh;background:#FFFFFF;border:1px solid #E5E7EB;border-radius:14px;box-shadow:0 12px 36px rgba(0,0,0,.18);z-index:2147483601;display:none;flex-direction:column;overflow:hidden}' +
    ...
    '.rhc-widget-messages{height:auto;min-height:120px;overflow-y:auto;background:#F7F8FA;padding:14px;display:flex;flex-direction:column;gap:10px}' +
